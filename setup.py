...
def _assemble_shellcodes():
    ...
    f32_raw = assemble(ASM_DIR / 'cxx_eh_fixer32.asm', keystone.KS_ARCH_X86, keystone.KS_MODE_32)
    # x86 magic: 0xFEFEFEFE (any 32-bit value works for ADD EAX, imm32 in x86)
    f32 = _patch_forward_magic(f32_raw, b'\xe8\x0c\x00\x00\x00', b'\xfe\xfe\xfe\xfe')
    ...
    SHELLCODES_PY.write_text(
        ...
        f"CXX_EH_FIXER_32     = bytes.fromhex('{f32.hex()}')\n"
